...
// The algorithm plan and the line-by-line code bridge moved to AlgorithmBridge so
// problem O, which has no strategy guide and renders ButtonRuleExplorer instead,
// gets the same help translating its plan into code.
